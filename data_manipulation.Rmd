...
select(janitor::clean_names(read_csv("data/FAS_litters.csv"),na = c("NA","",".")), -pups_born_alive, group == "Con7")
```
...
Select() keep the data structure while pull() only gets the numbers out
